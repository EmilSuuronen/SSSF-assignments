...
// userPost uses addUser function from userModel
// userPost uses validationResult to validate req.body
...
// userPutCurrent uses updateUser function from userModel
// userPutCurrent uses validationResult to validate req.body
...
// userDelete uses deleteUser function from userModel
// userDelete uses validationResult to validate req.params.id
// userDelete uses req.user to get role
